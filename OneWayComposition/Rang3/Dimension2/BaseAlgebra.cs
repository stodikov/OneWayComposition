    ...
    class BaseAlgebra
    {
        public Dictionary<long, MultiOperation> getBaseAlgebra(MetaOperations meta)
        {
            ...
            int[][] baseAlgebraInBinary = new int[][]
            {
                ...
                //new int[] { 1, 0, 0, 0, 0, 0, 0, 0, 0 }, new int[] { 0, 0, 0, 0, 1, 0, 0, 0, 0 }, new int[] { 0, 0, 0, 0, 0, 0, 0, 0, 1 },
                //new int[] { 1, 1, 1, 1, 1, 1, 1, 1, 1 }, new int[] { 1, 1, 1, 1, 1, 1, 1, 1, 1 }, new int[] { 1, 1, 1, 1, 1, 1, 1, 1, 1 },
                new int[] { 1, 1, 1, 0, 0, 0, 0, 0, 0 }, new int[] { 0, 0, 0, 1, 1, 1, 0, 0, 0 }, new int[] { 0, 0, 0, 0, 0, 0, 1, 1, 1 },
                new int[] { 1, 0, 0, 1, 0, 0, 1, 0, 0 }, new int[] { 0, 1, 0, 0, 1, 0, 0, 1, 0 }, new int[] { 0, 0, 1, 0, 0, 1, 0, 0, 1 },
                //new int[] { 1, 0, 0, 0, 1, 0, 0, 0, 1 }, new int[] { 1, 0, 0, 0, 1, 0, 0, 0, 1 }, new int[] { 1, 0, 0, 0, 1, 0, 0, 0, 1 }
            };
